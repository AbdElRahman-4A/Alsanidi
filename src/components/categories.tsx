    ...
    <div className="categories container mx-auto px-4 py-3 sm:px-6 lg:px-8 flex items-center">
      <div className="row-all w-full flex flex-wrap">
        ...
        {Categoriess.map((Category, index) => (
          ...
          >
            <div
              className={`type-category text-center lg:p-4 p-2 lg:min-h-[140px] lg:min-w-[75px] max-h-[85px] max-w-[85px] md:max-h-none md:max-w-none  cursor-pointer bg-white rounded-md ${
