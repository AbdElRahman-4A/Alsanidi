  ...
  return (
    <main className="">
      <div className="">
        ...
        <Categories />
        <Kampa />
        <ProductHome titleProductCategory="Gallons" />
        <ProductHome titleProductCategory="Mat" />
        <div className="lg:block hidden">
          <ProductHome titleProductCategory="Car refrigerators" />
        </div>
        ...
        <div className="lg:block hidden">
          <ProductHome titleProductCategory="Picnic chairs" />
        </div>
